...
$(function() {
    ...
    $('#show-hide-navbar').on('click', function() {
      $('#hide-vertical-bar-1, #content-all').toggleClass('active');
         $(".onlick-adjust").toggleClass("active");
    });
  });

  $(function() {
  
    $('#opn-ver-nav').on('click', function() {
      $('#hide-vertical-bar-2').toggleClass('active');
      $('.ds-text').show();
